...
namespace GNRS.ModuloPresupuesto.BL.BC
{
    public class PresupuestoPersonalProyectadoBC
    {
        ...
        {
            return personaDALC.listarCategorias();
        }

        public List<PersonaBE> listarPersonalProyectado(Int32 idCategoria, String estado, Int32 idLocalidad, Int32 idArea, Int32 idSeccion)
        {
            return personaDALC.listarPersonasProyectadas(idCategoria, estado, idLocalidad, idArea, idSeccion);
        }
...
<<<<<<< HEAD
            ...
            string pass = "pass";
=======
            string strTo = "angelpa38@gmail.com";
            string strFrom = "angelpa38@gmail.com";
            string pass = "xxxxx";
>>>>>>> Integracion US
